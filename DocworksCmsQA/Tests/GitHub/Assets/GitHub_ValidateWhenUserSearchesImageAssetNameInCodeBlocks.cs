...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class GitHub_ValidateWhenUserSearchesImageAssetNameInCodeBlocks : BeforeTestAfterTest
    {
        ...
        public void AddPProjectModule()
        {
          ...
          [Test, Description("Verify User is not able to get the Image When searched by AssetName of Image in CodeBlocks Tab")]
        public void ValidateWhenUserSearchesImageAssetNameInCodeBlocks()
        {
            try
            {
