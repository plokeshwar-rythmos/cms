...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class GitHub_3_ValidationOfCreateDraftsOfExistingAndBlankWithValidDraftNames : BeforeTestAfterTest
    {
        ...
        public void GitHub_3A_ValidateScreenEnhancementsWhenUserEditsExistingContentInLeftGdoc()
        {
            try
            {
        ...
        public void GitHub_3B_ValidationWhenEditedExistingDraftInLeftGDocGetsReflectedInRightSideTabs()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
        ...
        public void GitHub_3C_ValidationOfScreenEnhancementsUserEditsExistingContentInRightGdoc()
      ...
      [Test, Description("Verify User is Able to view changes made of Existing Draft in Right GDOC are reflected in Left Side Tabs")]
        public void GitHub_3D_ValidationWhenUserEditedRightGDocGetsReflectedInLeftSideTabs()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
