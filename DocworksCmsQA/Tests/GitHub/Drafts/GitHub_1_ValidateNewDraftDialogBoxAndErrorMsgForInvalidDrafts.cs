...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class GitHub_1_ValidateNewDraftDialogBoxAndErrorMsgForInvalidDrafts : BeforeTestAfterTest
    {
        ...
        public void GitHub_1A_ValidateNewDraftDialogBoxIsAppearedOrNot()
        {
        ...
        public void GitHub_1B_ValidateErrorMesgForInvalidDraftName()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
