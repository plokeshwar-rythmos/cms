...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class TC_30_ValidateUploadOfInvalidCodeBlock : BeforeTestAfterTest
    {
        ...
        public void TC30_ValidateUploadOfInvalidCodeBlock()
        {
            try
            {
                ...
                project.SuccessScreenshot("Unable to Upload CodeBlocks");
            }
            catch (Exception e)
            {
