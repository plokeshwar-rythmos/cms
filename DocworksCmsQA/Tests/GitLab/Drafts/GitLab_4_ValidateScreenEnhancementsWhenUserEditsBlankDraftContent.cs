...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class GitLab_4_ValidateScreenEnhancementsWhenUserEditsBlankDraftContent : BeforeTestAfterTest
    {
        ...
        public void GitLab_4A_ValidateScreenEnhancementsWhenUserEditsBlankContentInLeftGdoc()
        {
            try
            {
        ...
        public void GitLab_4B_ValidationWhenEditedBlankDraftInLeftGDocGetsReflectedInRightSideTabs()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
        ...
        public void GitLab_4C_ValidationOfScreenEnhancementsUserEditsBlankContentInRightGdoc()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
        ...
        public void GitLab_4D_ValidationWhenUserEditedRightGDocGetsReflectedInLeftSideTabs()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
