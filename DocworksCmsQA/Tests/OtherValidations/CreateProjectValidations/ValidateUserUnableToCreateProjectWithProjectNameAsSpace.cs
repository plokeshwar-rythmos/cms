...
namespace DocworksCmsQA.Tests.OtherValidations.CreateProjectValidations
{
    ...
    [Parallelizable]
    class ValidateUserUnableToCreateProjectWithProjectNameAsSpace : BeforeTestAfterTest
    {
        ...
        [Test, Description("Verifying that the user is unable to create project when the project name is given as space")]
        public void TC47_ValidateUserUnableToCreateProjectWithProjectNameAsSpace()
        {
            try
            {
