...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class Mercurial_3_ValidateScreenEnhancementsWhenUserEditsExistingDraftContent : BeforeTestAfterTest
    {
        ...
        public void Mercurial_3A_ValidateScreenEnhancementsWhenUserEditsExistingContentInLeftGdoc()
        {
            try
            {
        ...
        public void Mercurial_3B_ValidationWhenEditedExistingDraftInLeftGDocGetsReflectedInRightSideTabs()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
        ...
        public void Mercurial_3C_ValidationOfScreenEnhancementsUserEditsExistingContentInRightGdoc()
      ...
      [Test, Description("Verify User is Able to view changes made of Existing Draft in Right GDOC are reflected in Left Side Tabs")]
        public void Mercurial_3D_ValidationWhenUserEditedRightGDocGetsReflectedInLeftSideTabs()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
