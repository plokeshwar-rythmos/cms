...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class Mercurial_2_ValidationOfCreateDraftsOfExistingAndBlankWithValidDraftNames : BeforeTestAfterTest
    {
        ...
        public void AddPProjectModule()
        {
            ...
            System.Threading.Thread.Sleep(5000);
             ...
             public void Mercurial_2A_ValidationOfBlankDraftWithValidDraftName()
             {
                 try
                 {
        ...
        public void Mercurial_2B_ValidationOfExistingDraftWithValidDraftName()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
