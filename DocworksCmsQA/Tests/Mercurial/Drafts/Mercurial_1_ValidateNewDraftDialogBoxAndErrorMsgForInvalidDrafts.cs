...
namespace DocWorksQA.Tests
{
    ...
    [Parallelizable]
    class Mercurial_1_ValidateNewDraftDialogBoxAndErrorMsgForInvalidDrafts : BeforeTestAfterTest
    {
        ...
        public void Mercurial_1A_ValidateNewDraftDialogBoxIsAppearedOrNot()
        {
        ...
        public void Mercurial_1B_ValidateErrorMesgForInvalidDraftName()
        {
            try
            {
                String TestName = (TestContext.CurrentContext.Test.Name.ToString());
